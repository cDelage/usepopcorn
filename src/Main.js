...
export function Movie({ movie, onUpdateSelectedId}) {
  return (
    <li key={movie.imdbID} onClick={() => {onUpdateSelectedId(movie.imdbID)}}>
  ...
  return (
    <li key={movie.imdbID}>
      ...
      <div>
        ...
        <button className="btn-delete" onClick={onRemoveMovie}>X</button>
      </div>
    </li>
  );
}
